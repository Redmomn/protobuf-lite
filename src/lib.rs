...
mod tests {
    ...
    use crate::protobuf::ProtoData::Message;
    use crate::protobuf::{decode_protobuf, Map, ProtoData};
    use std::vec;
    ...
    fn test_decode_protobuf() {
        ...
        expect_pb.insert(7, ProtoData::String("1145141919810".to_string()));
        expect_pb.insert(
            8,
            ProtoData::Repeated(vec![
                ProtoData::String("this".to_string()),
                ProtoData::String("is".to_string()),
                ProtoData::String("a".to_string()),
                ProtoData::String("repeated".to_string()),
                ProtoData::String("string".to_string()),
            ]),
        );
        expect_pb.insert(
            9,
